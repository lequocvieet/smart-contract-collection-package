...
contract DSChiefApprovals is DSThing {
    ...
    function vote(
        ...
        public
        returns (
            bytes32 // note  both sub-calls note
        )
    {
    ...
    function votez(bytes32 slate) public note {
        require(
    ...
    function getCurrentChief() public view returns (address) {
        return hat;
    }
}
...
contract DSChief is DSRoles, DSChiefApprovals {
    constructor(
        ...
        DSToken IOU,
        uint MAX_YAYS
    ) public DSChiefApprovals(GOV, IOU, MAX_YAYS) {
        authority = this;
        owner = address(0);
    }
