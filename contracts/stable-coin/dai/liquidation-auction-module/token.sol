...
contract DSToken is DSMath, DSAuth {
    ...
    function approve_max(address guy) external returns (bool) {
    ...
    function mint(uint wad) external {
        mintz(msg.sender, wad);
    }

    function burn(uint wad) external {
        burnz(msg.sender, wad);
    }
    ...
    function burnz(address guy, uint wad) public auth stoppable {
